        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="phone_number" id="phone_number" placeholder="Phone number" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('phone_number') border-red-500 @enderror" value="{{ old('phone_number') }}">
